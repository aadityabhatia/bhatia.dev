...
- Resource Requirements
    ...
    - Electricity
    - Time
- Token cost per unit of productivity
...
- Expose tools to language models
- A step beyond prompting and chatting
...
- [MCP allows servers to expose tools](https://modelcontextprotocol.io/)
:::
::::
...
- README for agents
- Context provided to _every_ agent operating in the directory
...
- Instructions; no data or product artifacts
...
- Use custom agents that will [do one thing well](https://en.wikipedia.org/wiki/Mr._Meeseeks).
...
Source: [github.com/aadityabhatia/agents-opencode](https://github.com/aadityabhatia/agents-opencode), inspired by [OpenSpec](https://openspec.dev/)
...
- Models
    - [Mistral Medium 3.5](https://docs.mistral.ai/models/overview) - long-running goal-oriented tasks
    - [Poolside Laguna XS 2.1](https://poolside.ai/blog/introducing-laguna-xs-2-1) - excellent developer
    - [Mistral Small 4](https://docs.mistral.ai/models/overview) - reviewer, tester
