...
- Adds new capabilities; bloats context
:::
::::
...
- Proprietary harnesses are black boxes
    - [System prompts are huge](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools); user has no control
- Context grows quickly
    - Difficulty reasoning and following instructions
    - Performance degrades
- Agent orchestrated manually
